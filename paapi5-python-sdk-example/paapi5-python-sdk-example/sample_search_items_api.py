...
def search_items():
    ...
    search_items_resource = [
        ...
        SearchItemsResource.OFFERSV2_LISTINGS_ISBUYBOXWINNER,
        SearchItemsResource.OFFERSV2_LISTINGS_LOYALTYPOINTS,
        SearchItemsResource.OFFERSV2_LISTINGS_MERCHANTINFO,
        SearchItemsResource.OFFERSV2_LISTINGS_PRICE,
        SearchItemsResource.OFFERSV2_LISTINGS_TYPE,
    ]
        ...
        if response.search_result is not None:
            ...
            if item_0 is not None:
                ...
                if (
                    ...
                    and "Money" in item_0.offers_v2.listings[0]["Price"]
                    and "DisplayAmount"
                    in item_0.offers_v2.listings[0]["Price"]["Money"]
                ):
                    print(
                        "Buying Price: ",
            ...
            if response.search_result is not None:
                ...
                if item_0 is not None:
                    ...
                    if (
                        ...
                        and len(item_0.offers_v2.listings) > 0
                        and "Price" in item_0.offers_v2.listings[0]
                        and item_0.offers_v2.listings[0]["Price"]["Money"][
                            "DisplayAmount"
                        ]
                        is not None
                    ):
                        print(
                            "Buying Price: ",
                            item_0.offers_v2.listings[0]["Price"]["Money"][
                                "DisplayAmount"
                            ],
                        )
            if response.errors is not None:
        ...
        if response.search_result is not None:
            ...
            if item_0 is not None:
                ...
                if (
                    ...
                    and len(item_0.offers_v2.listings) > 0
                    and "Price" in item_0.offers_v2.listings[0]
                    and item_0.offers_v2.listings[0]["Price"]["Money"]["DisplayAmount"]
                    is not None
                ):
                    print(
                        "Buying Price: ",
