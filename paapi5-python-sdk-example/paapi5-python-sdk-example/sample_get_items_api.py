...
def get_items():
    ...
    """ Choose item id(s) """
    item_ids = ["059035342X", "B0BFC7WQ6R", "B00ZV9RDKK"]
                ...
                if item_id in response_list:
                    ...
                    if item is not None:
                        ...
                        if (
                            ...
                            and len(item.offers_v2.listings) > 0
                            and "Price" in item.offers_v2.listings[0]
                            and item.offers_v2.listings[0]["Price"]["Money"][
                                "DisplayAmount"
                            ]
                            is not None
                        ):
                            print(
                                "Buying Price: ",
                                item.offers_v2.listings[0]["Price"]["Money"][
                                    "DisplayAmount"
                                ],
                            )
                else:
