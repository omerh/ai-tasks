...
def get_variations():
    ...
    get_variations_resources = [
        ...
        GetVariationsResource.OFFERSV2_LISTINGS_AVAILABILITY,
        GetVariationsResource.OFFERSV2_LISTINGS_CONDITION,
        GetVariationsResource.OFFERSV2_LISTINGS_DEALDETAILS,
        GetVariationsResource.OFFERSV2_LISTINGS_ISBUYBOXWINNER,
        GetVariationsResource.OFFERSV2_LISTINGS_LOYALTYPOINTS,
        GetVariationsResource.OFFERSV2_LISTINGS_MERCHANTINFO,
        GetVariationsResource.OFFERSV2_LISTINGS_PRICE,
        GetVariationsResource.OFFERSV2_LISTINGS_TYPE,
    ...
    try:
        ...
        if response.variations_result is not None:
            ...
            if item_0 is not None:
                ...
                if (
                    item_0.offers_v2 is not None
                    and item_0.offers_v2.listings is not None
                    and len(item_0.offers_v2.listings) > 0
                    and "Price" in item_0.offers_v2.listings[0]
                    and item_0.offers_v2.listings[0]["Price"]["Money"]["DisplayAmount"] is not None
                ):
                    print(
                        "Buying Price: ", item_0.offers_v2.listings[0]["Price"]["Money"]["DisplayAmount"]
                    )
            ...
            if response.variations_result is not None:
                ...
                if item_0 is not None:
                    ...
                    if (
                        ...
                        print(
                            "Buying Price: ",
                            item_0.offers_v2.listings[0]["Price"]["Money"]["DisplayAmount"],
                        )
            if response.errors is not None:
                print(
                    "\nPrinting Errors:\nPrinting First Error Object from list of Errors"
